...
const HeaderComponent = ({ title, placeholder, value, onChange, route }) => {
  ...
  return (
    <header className="w-[95%] flex flex-row justify-between mb-1 sm:mb-0">
      ...
      <div className="text-end">
        <form className="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
          ...
          <button
            ...
            className="flex-shrink-0 px-4 py-1 text-base font-semibold text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200"
            type="submit"
          >
            Adicionar
          </button>
